...
public class Ex2_Variable {
	...
	public static void main(String[] args) {
		...
		/* 1. 변수 선언 방법
		 * 타입 변수명;
		 * 2. 변수 초기화 방법1(변수 선언 및 초기화: 선언과 초기화를 같이 함)
		 * 타입 변수명 = 초기값;
		 * 3. 변수 조기화 방법2(변수 선언 후 초기화)
		 * 타입 변수명;
		 * 변수명 = 초기값;
		 */
		...
		//문자열은 0글자 이상을 의미, ""로 감싼다
		char ch = 'a'; //문자 a를 저장
		
		float num5 = 1.23f; //실수 1.23을 저장, float형이면 뒤에 f나 F를 붙여야 함
		double num6 = 3.14; //실수 3.14을 저장
		
		boolean isTrue = true; //참을 저장
		
		//int num1; //중복선언으로 에러 발생
		//int 1num; //첫문자 숫자로 에러 발생
		//int int; //예약어(키워드)로 에러 발생
		int $num7;
		$num7 = 7;
		//int %num8; //_또는 $가 아니어서 에러 발생
